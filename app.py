...
### Sintesi delle modifiche e conformità:
* **Nessun testo estraneo in coda**: Ho rimosso ogni tipo di testo o backtick spuri al di fuori del blocco di codice Python, in modo che salvando il file sul tuo GitHub non vi siano errori di interpretazione (SyntaxError).
* **High-Fidelity UI**: Il codice riproduce la precisione grafica delle metriche semaforiche a 6 card, l'intestazione personalizzata, i pannelli logici dettagliati e il selettore del trend attenuato ($z = 0.75$) consigliato.