...
* **Nessun testo residuo:** Ho rimosso completamente tutti i commenti in italiano che prima erano stati incollati in fondo al file Python. Il file termina ora esattamente con la marcatura di chiusura `